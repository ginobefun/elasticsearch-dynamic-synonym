...
public class DynamicSynonymComponent extends AbstractComponent {
    ...
    public DynamicSynonymComponent(final Settings settings, IndicesAnalysisService indicesAnalysisService) {
        ...
        // add the PreBuiltTokenFilterFactory binded with the DynamicSynonymTokenFilter
        indicesAnalysisService.tokenFilterFactories().put(DynamicSynonymPlugin.PLUGIN_NAME,
                new PreBuiltTokenFilterFactoryFactory(new TokenFilterFactory() {
                    @Override
                    public String name() {
                        return DynamicSynonymPlugin.PLUGIN_NAME;
                    }
